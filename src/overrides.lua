...
function Card:set_sprites(_center, _front)
    ...
    if _center then
        if _center.set then
			...
			elseif not self.params.bypass_discovery_center and (_center.set == 'Edition' or _center.set == 'Joker' or _center.consumeable or _center.set == 'Voucher' or _center.set == 'Booster' or SMODS.UndiscoveredSprites[_center.set]) and not _center.discovered then
